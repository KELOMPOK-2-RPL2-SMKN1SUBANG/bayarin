                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ '/admin/students/' . $student['id'] }}" method="post">
                                ...
                                <a href="{{ '/admin/students/' . $student['id'] . '/edit' }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                <a href="{{ '/admin/students/' . $student['id'] }}" class="btn btn-info"><i class="fa fa-search"></i></a>
                            </form>
                        </td>
                    </tr>
                    @endforeach
